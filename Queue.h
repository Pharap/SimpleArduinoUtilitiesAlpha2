...
public:
	...
	//static_assert(CapacityValue > 0, "Attempt to create Queue with a capacity less than 1");
	static_assert(CapacityValue < 128, "Attempt to create Queue with a capacity greater than 127");
...
public:
	...
	// O(1)
	bool enqueue(const ValueType & item)
	{
