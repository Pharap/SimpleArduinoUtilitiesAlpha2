...
public:
	...
	//static_assert(capactiyValue > 0, "Attempt to create List with a capacity less than 1");
	static_assert(capactiyValue < 128, "Attempt to create List with a capacity greater than 127");
